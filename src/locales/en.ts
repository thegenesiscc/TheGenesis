...
export default {
  ...
  mh: {
    title: 'Mystery Boxes, Surprises Await',
    description: 'Our unique mystery boxes system brings endless surprises to every player. Each mystery box may contain rare items, powerful equipment, or limited-edition characters. When you open a mystery box, dazzling light effects will reveal the true treasure inside. The rarity of the mystery boxes ranges from common to legendary, with rarer boxes offering a higher chance of obtaining precious items.',
  },
  mint: {
  ...
  home: {
    ...
    marketData: {
      ...
      analytics: {
        ...
        description: '• Start the mystery box sale. Collect user feedback to optimize the game experience.',
      ...
      dashboards: {
        ...
        description2: '• Launch more themed mystery boxes, limited-time events, and collaborative projects.'
      },
      historical: {
  ...
  features: {
    ...
    fast: {
      ...
      description: 'Each mystery box contains an NFT item, divided into different rarities, corresponding to different mining abilities.'
    },
    liquidity: {
  ...
  gameplay: {
    title: 'How to play',
    descriptions:'The Genesis is a decentralized adventure and mining game combining blockchain and gamification mechanics. The core gameplay revolves around mystery box openings, character progression, resource mining, and market trading. Players can obtain characters and items by purchasing or unlocking mystery boxes, mine resources, and receive rewards.',
    chapter1: {
      title: '1. Mystery Boxes Opening:',
      description: 'Mystery Boxes System: The starting point of the game is mystery box opening, where players can buy mystery boxes generated by the system (using BNB, popular tokens, etc.). Each mystery box contains different items, characters, or resources (such as miners, elemental sprites, mechanical pets, magical runes, etc.), with the contents being random. Players will rely on luck and strategy to obtain rare items.',
      description1: 'Mystery Boxes Levels: mystery boxes are divided into different levels, including Common, Rare, Legendary, etc., with the rarity and power of the items varying by level. Rare items such as “Elemental Sprite Faryna” or “Alchemist Morris” can bring players stronger mining abilities or special skills.'
    },
    chapter2: {
      title: '2. Character Skills:',
      description: 'Miner Characters: Players can acquire different types of miner characters, each with unique skills and attributes. Players can enhance their character’s abilities through mining, battles, etc., unlocking higher-level skills and item usage abilities. For example, Miner Alder can increase mining efficiency, while other miners are better at finding hidden resources or improving resource returns.',
      description1: 'Elemental Sprites: These small magical life forms possess powerful elemental abilities. By interacting with the sprites, players can enhance their skills and use their powers to strengthen mining efforts or defend mining areas.',
      description2: 'Alchemists: These mechanically engineered life forms assist players by increasing mining efficiency, protecting players from other adventurers’ attacks, or preventing dangerous creatures from invading the mining area.'
    },
    chapter3: {
      title: '3. Mining System:',
      description: 'Vein Mining: Players must choose different mineral veins to mine. Each vein has different resources and difficulty levels, and players must select the appropriate vein based on the characters, items, and skills they possess.',
      description1: 'Mining Rewards: Players can receive various types of resources, such as ores, magical elements, rare runes, etc., by mining. These resources can be used to upgrade character abilities, trade, or sell.',
      description2: 'Mining Crisis: As players mine deeper, the dangers in the mining area increase. They may encounter monsters from deeper veins, mechanical traps, or even competition from other players. Players must proceed with caution and continuously improve the abilities of their characters and items.'
    },
    chapter4: {
      title: '4. Marketplace & Trading:',
      description: 'Resource and Item Trading: Players can trade ores, elemental sprites, mechanical pets, and other resources or items through the marketplace. The marketplace uses blockchain technology to ensure the transparency and security of transactions.',
      description1: 'Item Upgrades & Crafting: Through crafting and enhancement, players can upgrade their items and characters to create more powerful gear and abilities. Rare items may become essential resources in the game or valuable commodities in the marketplace.'
    },
    chapter5: {
      title: '5. Economic System & Token Mechanism:',
      description: 'Token System: The main tokens in the game include BNB (used for purchasing mystery boxes, trading items, paying fees, etc.) and TGS(used for participating in major in-game activities). Players can earn TGS or other reward tokens by mining, completing tasks, and more.',
      description1: 'Staking & Locking Mechanism: Players can lock or stake their tokens to receive additional rewards or special in-game items. Locked tokens not only provide rewards but also enhance the player’s standing and power in the game.'
    },
    chapter6: {
      title: '6. Social & Interaction:',
      description: 'Guild System: Players can create or join guilds, team up with others to mine veins, defeat enemies, or participate in guild wars. Guilds can also share resources and help each other level up.',
      description1: 'PVP Competitions: In certain areas, players can engage in real-time battles with others, competing for resources, veins, or other valuable items. PVP battles carry higher risks but offer greater rewards.',
      description2: 'Leaderboards & Achievements: Players can increase their rankings through competitions, tasks, and mining, earning rich rewards. The leaderboard showcases the strongest players, wealthiest miners, and most popular sprites.'
    },
    chapter7: {
      title: 'Game Features:',
      description: 'Diverse Characters & Skill Trees: Depending on the type of miner or sprite, players can choose different strategies, enhance skills, and enjoy varied gameplay experiences.',
      description1: 'Decentralized Trading: All items, resources, and characters can be traded via blockchain, ensuring transparency and security.',
      description2: 'NFT Mystery Boxes System: Players open mystery boxes to obtain rare items in the game, adding fun and randomness to the experience.',
    ...
    conclusion:'The Genesis provides players with an adventurous, challenging, and mysterious world, blending blockchain technology, NFTs, PVP, and PVE elements. Whether opening mystery boxes, battling or cooperating with others, every decision in the game is filled with possibilities and changes. Players are not just miners but adventurers, merchants, and strategists, ultimately writing their own legend in a world full of mystery and magic!'
  },
  subscription: {
  ...
  md: {
    ...
    activityBackgroundContent: "To further activate the market and lay a solid foundation for the official mystery box sale, TheGenesis project has decided to launch a limited subscription event. All users who participate in this event will become our Early Bird members. Through this activity, we aim to attract more users to join TheGenesis community early and provide early support for the mystery box sale. At the same time, Early Bird members will enjoy special discounts and exclusive benefits, setting a solid foundation for future game participation and market activities.",
    ...
    subscriptionFeeContent: "Each subscription spot requires a payment of 0.01 BNB. By paying this fee, users will receive one Early Bird membership and enjoy discounts during the upcoming mystery box sale.",
    
    benefitsAfterSubscriptionTitle: "Benefits After Successful Subscription:",
    benefit1: "10% Discount: Users who successfully subscribe will receive a 10% discount on mystery box purchases, equivalent to a coupon ensuring a lower price for future mystery box purchases.",
    ...
    benefit4: "Referral Commission System: Early Bird members not only receive benefits for themselves but can also earn commission rewards by inviting other players to participate in mystery box purchases. For each mystery box purchased by a new user invited via the referral link, the inviter will receive a 10% commission. The commission will be directly returned to the inviter’s wallet.",
