...
export default {
  ...
  gameplay: {
    title: 'How to play',
    descriptions:'The Genesis is a decentralized adventure and mining game combining blockchain and gamification mechanics. The core gameplay revolves around blind box openings, character progression, resource mining, and market trading. Players can obtain characters and items by purchasing or unlocking blind boxes, mine resources, and receive rewards.',
    chapter1: {
      title: '1. Blind Box Opening:',
      description: '• Blind Box System: The starting point of the game is blind box opening, where players can buy blind boxes generated by the system (using BNB, popular tokens, etc.). Each blind box contains different items, characters, or resources (such as miners, elemental sprites, mechanical pets, magical runes, etc.), with the contents being random. Players will rely on luck and strategy to obtain rare items.',
      description1: '• Blind Box Levels: Blind boxes are divided into different levels, including Common, Rare, Legendary, etc., with the rarity and power of the items varying by level. Rare items such as “Elemental Sprite Faryna” or “Alchemist Morris” can bring players stronger mining abilities or special skills.'
    },
    chapter2: {
    ...
    chapter5: {
      ...
      description: '• Token System: The main tokens in the game include BNB (used for purchasing blind boxes, trading items, paying fees, etc.) and TGS(used for participating in major in-game activities). Players can earn TGS or other reward tokens by mining, completing tasks, and more.',
    ...
    chapter7: {
      ...
      description2: '• NFT Blind Box System: Players open blind boxes to obtain rare items in the game, adding fun and randomness to the experience.',
